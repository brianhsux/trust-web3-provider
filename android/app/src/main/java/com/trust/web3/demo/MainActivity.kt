...
//        private const val DAPP_URL = "https://onboard.blocknative.com/examples/connect-wallet"
//        private const val DAPP_URL = "https://web3modal.com/try-it-out"
        private const val DAPP_URL = "https://staging.wellcomemax.cryptosports.one/"
    ...
    private fun loadInitJs(chainId: Int, rpcUrl: String): String {
        Log.d("chromium", "loadInitJs, chainId: $chainId, rpcUrl: $rpcUrl");
        val source = """
        (function() {
            var config = {                
                ethereum: {
            ...
            window.trustwallet.solana = trustwallet.solana;
        })();
        """
        return  source
    }
